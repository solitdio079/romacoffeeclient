      ...
      <div className="flex w-full flex-wrap items-center justify-between">
        ...
        <div className="flex h-5 gap-4">
          ...
          <a href="https://bysolitdio.net" className="link" aria-label="Google Link">
            <img src="./bysolitdio.svg" className="w-24 bg-black"></img>
          </a>
        </div>
      </div>
    </footer>
...
const Gallery = () => {
  return (
    <div
      ...
      className="flex  intersect:motion-preset-slide-up flex-col intersect:motion-opacity-in-0 intersect:motion-duration-[2s] items-center lg:flex p-10"
    >
      <div
