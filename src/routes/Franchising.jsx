...
export default function Franchise() {
  ...
  return (
    <div
      id="contact"
      className="flex intersect:motion-preset-slide-up intersect:motion-opacity-in-0 intersect:motion-duration-[2s] flex-col-reverse backdrop-blur-md items-center lg:flex-row p-10"
    >
      <div className="lg:w-1/2 w-full justify-items-center lg:justify-items-start text-center lg:text-left flex-col justify-center  space-y-4">
        <p className="text-base-content/80 text-base text-primary">Bizden</p>
        <h1 className="font-bold text-5xl">Franchise alın</h1>
